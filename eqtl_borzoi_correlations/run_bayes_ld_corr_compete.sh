...
python run_bayes_ld_corr_compete.py $bayes_input_data_summary_file $tissue_name $borzoi_gtex_independent_target_names_file $bayes_ld_corr_output_stem $prior_version
