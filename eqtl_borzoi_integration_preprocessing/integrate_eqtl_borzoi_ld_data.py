...
def generate_summary_file_ready_for_inv_ld(borzoi_summary_file, inverse_ld_extension_summary_file, LD_output_dir, eqtl_ss_output_dir):
	head_count = 0
	...
	for line in f:
		...
		t.write(data[0] + '\t' + data[1] + '\t' + data[2] + '\t' + data[3] + '\t' + data[4] + '\t' + inv_ld_file + '\t' + data[5] + '\t' + data[6] + '\t' + data[7] + '\n')
